"""
سایدبار Apple-Style سمت راست با آیکون‌های SVG یکپارچه
"""
...
class SidebarItem(QPushButton):
    def __init__(self, svg_name: str, text: str, parent=None):
        ...
        self.setIcon(get_icon(svg_name, size=20))
...
class Sidebar(QWidget):
    ...
    def _setup_ui(self):
        ...
        logo_icon = QLabel()
        logo_icon.setPixmap(get_pixmap("app_icon", 38))
    ...
    def _add_profile_card(self, parent_layout):
        ...
        avatar = QLabel()
        avatar.setPixmap(get_pixmap("user", 22, "#ffffff"))

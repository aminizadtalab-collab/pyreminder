"""
نوار عنوان سفارشی با آیکون‌های SVG
"""
from datetime import datetime
from PyQt6.QtCore import Qt, QTimer, QPoint, QSize, pyqtSignal
from PyQt6.QtWidgets import QWidget, QHBoxLayout, QLabel, QPushButton
from PyQt6.QtGui import QIcon
from app.config import TITLE_BAR_HEIGHT, APP_NAME, icon_path


class WindowButton(QPushButton):
    def __init__(self, icon_name: str, tooltip: str, is_close: bool = False, parent=None):
...
class TitleBar(QWidget):
    ...
    def _setup_ui(self):
        ...
        app_icon = QLabel()
        app_icon.setPixmap(
            QIcon(icon_path("diamond")).pixmap(QSize(18, 18))
        )
        ...
        clock_icon.setPixmap(
            QIcon(icon_path("clock")).pixmap(QSize(14, 14))
        )
